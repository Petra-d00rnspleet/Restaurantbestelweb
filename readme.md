...
- **Berichten van bezoekers** lezen — op het startscherm staat een apart keuzevak "💬 Bericht naar sitebeheer" (naast "Restaurant maken" en "Restaurant joinen"), waar iedereen, nog vóórdat er een restaurant gekozen is, een simpel bericht naar de bouwer van de site kan sturen (geen wachttijd — gewoon zo vaak als nodig). Elk bericht komt hier binnen met naam en tijdstip, en is met ✕ weg te klikken zodra je het verwerkt hebt.
- **Naamlimiet per restaurant**: bij elk restaurant staat een knop "Naamlimiet" waarmee je, los van de standaardlimiet van 10 letters, per restaurant een eigen maximumaantal letters voor de restaurantnaam instelt (of weer terugzet naar de standaard door het veld leeg te laten). Die limiet geldt meteen bij dat ene restaurant, zowel in Instellingen als overal elders waar de restaurantnaam gewijzigd wordt.
